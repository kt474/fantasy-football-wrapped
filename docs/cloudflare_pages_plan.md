...
- Deploy via Pages (GitHub hook or manual) and run the migrations: `npx wrangler d1 execute <db-name> --file migrations/0001_awards.sql --remote` and `npx wrangler d1 execute <db-name> --file migrations/0002_weekly_bonuses.sql --remote`.
