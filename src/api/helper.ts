...
export const fakeProjectionData = [
  ...
  },
  {
    name: "Quaalude Dudes",
    data: [
      { position: "RB", projection: 456 },
      { position: "WR", projection: 348 },
      { projection: 251, position: "QB" },
      { projection: 126, position: "K" },
      { projection: 93, position: "DEF" },
      { projection: 92, position: "TE" },
    ],
    total: 1366,
  },
  {
  ...
  },
  {
    name: "CCJ2K",
    data: [
      { position: "RB", projection: 383 },
      { position: "WR", projection: 352 },
      { projection: 268, position: "QB" },
      { projection: 91, position: "K" },
      { projection: 103, position: "DEF" },
      { projection: 103, position: "TE" },
    ],
    total: 1300,
  },
  {
