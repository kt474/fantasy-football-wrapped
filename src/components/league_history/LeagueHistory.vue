          ...
          <tr>
            ...
            <th scope="col" class="px-2 py-3 sm:px-6">
              ...
              <div
                ...
                class="absolute z-10 inline-block px-3 py-2 mt-2 text-sm font-medium normal-case bg-gray-900 rounded-lg shadow-sm text-gray-50 sm:-ml-20 tooltip dark:bg-gray-600"
              >
            ...
            <th scope="col" class="px-2 py-3 sm:px-6">
              ...
              <div
                ...
                class="absolute z-10 inline-block px-3 py-2 mt-2 text-sm font-medium normal-case bg-gray-900 rounded-lg shadow-sm text-gray-50 sm:-ml-20 tooltip dark:bg-gray-600 max-w-80"
              >
            ...
            <th scope="col" class="px-2 py-3 sm:px-6">
              ...
              <div
                ...
                class="absolute z-10 inline-block px-3 py-2 mt-2 text-sm font-medium normal-case bg-gray-900 rounded-lg shadow-sm text-gray-50 sm:-ml-10 tooltip dark:bg-gray-600"
              >
            ...
            <th scope="col" class="px-2 py-3 sm:px-6 dark:text-gray-200">
              ...
              <div
                ...
                class="absolute z-10 inline-block px-3 py-2 mt-2 text-sm font-medium normal-case bg-gray-900 rounded-lg shadow-sm text-gray-50 tooltip dark:bg-gray-600"
              >
                Seasons played
              </div>
            </th>
