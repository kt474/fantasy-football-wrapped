...
<template>
  <div class="bg-gray-50 mt-4 rounded dark:bg-gray-700 mx-2 p-4">
    ...
    <button
      v-if="preview === ''"
      @click="getPreview"
      class="text-gray-50 mt-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base sm:text-sm w-full sm:w-auto px-3 sm:px-3 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
      Generate
    </button>
