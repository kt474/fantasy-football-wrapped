...
<template>
  ...
  >
    ...
    <div class="flex w-full">
      <div
        role="status"
        class="w-full p-4 space-y-4 border border-border divide-y divide-border rounded-lg bg-card shadow-xs lg:mr-4 lg:w-3/4 animate-pulse md:p-6"
      >
      ...
      <div class="hidden w-1/4 lg:block">
        ...
        <div
          role="status"
          class="p-4 mt-4 border border-border rounded-lg bg-card shadow-xs animate-pulse md:p-6"
        >
          <div
            class="h-2.5 bg-muted rounded-full w-32 mb-2.5"
          ></div>
