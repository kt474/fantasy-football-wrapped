...
const visibleManagers = computed(() =>
  showAll.value
    ...
    : managersWithDraftHistory.value.slice(0, 6)
);

const hasHiddenManagers = computed(
  () => managersWithDraftHistory.value.length > 6
);
...
<template>
  <Card v-if="managersWithDraftHistory.length" class="p-4 md:p-6">
    <div>
    ...
    <div class="grid gap-4 mt-4 sm:grid-cols-2 md:grid-cols-3">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-muted-foreground">
              {{ manager.draftHistory.length }} tracked
        ...
        <div class="mt-3 space-y-2">
          ...
          >
            ...
            <div class="flex flex-wrap items-center gap-1.5">
              ...
              <span
                v-for="(position, index) in draft.positions"
        ...
        <div class="pt-3 mt-3 space-y-3 border-t">
          ...
          >
            ...
            <div class="grid grid-cols-2 gap-2 text-sm">
              <div class="px-2.5 py-2 rounded-md bg-secondary/60">
                <p
        ...
        >
          ...
          <p class="font-semibold">#{{ draftRankByUserId[manager.userId] }}</p>
        </div>
      </div>
    </div>
    ...
    <div v-if="hasHiddenManagers" class="flex justify-center mt-4">
      <Button
        :aria-label="
          showAll ? 'Show fewer draft tendencies' : 'Show all draft tendencies'
        "
