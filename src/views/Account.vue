...
import { authenticatedBackendFetch, getBackendBaseUrl } from "@/lib/backendApi";
...
import { ArrowRight, Check, CircleCheck } from "@lucide/vue";
            ...
            >
              <FieldGroup>
                ...
                <FieldDescription class="text-center">
                  ...
                  <button
                    type="button"
                    class="font-medium text-primary underline-offset-4 hover:underline focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                    :disabled="authStore.loading"
              ...
              <FieldGroup>
                ...
                <Field>
                  <div class="flex items-center">
                    ...
                    <button
                      type="button"
                      class="inline-block ml-auto text-sm text-primary underline-offset-4 hover:underline focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                      :disabled="authStore.loading"
            ...
            <div ref="pricingPaywall" class="max-w-sm">
              <Tabs v-model="displayedCheckoutPlan" class="w-full">
                <TabsList class="grid w-full h-10 grid-cols-2 rounded-control">
                  <TabsTrigger value="annual" class="gap-1.5 rounded-xs">
                    Annual
                  </TabsTrigger>
                  <TabsTrigger value="monthly" class="rounded-xs">
                    Monthly
                  </TabsTrigger>
                </TabsList>
              </Tabs>
