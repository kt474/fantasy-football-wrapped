...
const leaguePulse = [
  { label: "Power rank", value: "#2", note: "Up 3 this week", tone: "text-primary" },
...
const workflow = [
  {
    icon: ScanLine,
    title: "Connect",
    description: "Use a Sleeper username or league ID. Rosters, matchups, standings, and settings load together.",
  },
  {
    icon: CalendarRange,
    title: "Choose a lens",
    description: "Start with the current week, the playoff race, roster construction, or the full history of the league.",
  },
  {
    icon: ArrowUpRight,
...
<template>
  <PublicPageShell>
      ...
      >
        <div>
          ...
          <div class="flex flex-wrap gap-x-5 gap-y-2 mt-6 text-sm text-muted-foreground">
            ...
            <span class="inline-flex items-center gap-1.5"><Check :size="14" /> Current and linked seasons</span>
            <span class="inline-flex items-center gap-1.5"><Check :size="14" /> Free to explore</span>
          </div>
        </div>

        <Card class="overflow-hidden shadow-xl shadow-black/10 bg-card/95 backdrop-blur">
          <CardContent class="p-0">
            <div class="flex items-center justify-between gap-4 px-5 py-4 border-b">
              <div>
                <p class="text-xs font-medium tracking-wide uppercase text-muted-foreground">Sample league pulse</p>
            ...
            <dl class="grid grid-cols-2">
              ...
              >
                ...
                <dd class="mt-2 text-2xl font-semibold tracking-tight tabular-nums" :class="metric.tone">
                  {{ metric.value }}
                </dd>
            ...
            <div class="px-5 py-4 border-t bg-muted/30">
              <div class="flex items-center justify-between gap-3 text-sm">
                <span class="inline-flex items-center gap-2 font-medium"><Trophy :size="15" class="text-primary" /> Biggest mover</span>
                <span class="text-muted-foreground">Sunday Scaries · +18 pts</span>
              </div>
            </div>
          </CardContent>
        </Card>
    ...
    <section class="px-5 py-16 mx-auto max-w-6xl sm:py-20">
      <div class="grid gap-10 lg:grid-cols-[0.7fr_1.3fr]">
        <div class="lg:sticky lg:top-24 lg:self-start">
          <p class="text-sm font-medium text-primary">Four ways to read the league</p>
          ...
          <p class="mt-4 leading-7 text-muted-foreground">
            Each view combines the league signals that belong together, so a ranking or probability comes with the evidence behind it.
          </p>
        </div>
    ...
    <section class="border-y bg-muted/30">
      <div class="grid gap-12 px-5 py-16 mx-auto max-w-6xl sm:py-20 lg:grid-cols-[1fr_1fr] lg:items-center">
        <div>
          ...
          <p class="mt-4 leading-7 text-muted-foreground">
            Sleeper links renewed leagues from year to year. ffwrapped follows that chain so a manager profile can include the rivalry record, scoring history, and finishes that built it.
          </p>
        ...
        <div class="p-5 border bg-background rounded-card sm:p-6">
          ...
          <div class="relative mt-6 ml-2 border-l">
            <div class="relative pb-7 pl-6">
              <span class="absolute -left-1.5 top-1 w-3 h-3 rounded-full bg-primary ring-4 ring-background"></span>
              <p class="text-xs text-muted-foreground">2025 · Current</p>
              <p class="mt-1 font-medium">6–5 · Projected playoff seed #4</p>
            </div>
            <div class="relative pb-7 pl-6">
              <span class="absolute -left-1.5 top-1 w-3 h-3 rounded-full bg-muted-foreground ring-4 ring-background"></span>
              <p class="text-xs text-muted-foreground">2024 · Final</p>
              <p class="mt-1 font-medium">Runner-up · League-high 1,744 points</p>
            </div>
    ...
    <section class="px-5 py-16 mx-auto max-w-6xl sm:py-20">
      <div class="max-w-2xl">
        ...
        <h2 class="mt-2 text-3xl font-semibold tracking-tight">Built to become part of the season</h2>
      </div>
      <ol class="grid mt-10 overflow-hidden border divide-y rounded-card md:grid-cols-3 md:divide-x md:divide-y-0">
    ...
    <section class="px-5 pb-4 mx-auto max-w-6xl">
      <div class="relative flex flex-col items-start gap-6 p-7 overflow-hidden border rounded-feature bg-primary text-primary-foreground sm:flex-row sm:items-center sm:justify-between sm:p-9">
        ...
        <div class="relative">
          <h2 class="text-2xl font-semibold tracking-tight">See what your Sleeper standings leave out</h2>
          <p class="max-w-2xl mt-2 leading-7 text-primary-foreground/80">
            Add a league once, then follow the rankings, playoff race, roster decisions, and history as the season changes.
          </p>
        </div>
