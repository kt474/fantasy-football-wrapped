  ...
  <PublicPageShell>
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-3 mt-8">
            <Button as-child size="lg"
              ><RouterLink :to="analysisRoute"
                >Grade your draft</RouterLink
              ></Button
            >
            <Button as-child size="lg" variant="outline"
              ><RouterLink to="/sleeper-league-analyzer"
                >Sleeper draft grades</RouterLink
              ></Button
            >
          </div>
          <div
          ...
          >
            <span class="inline-flex items-center gap-1.5"
              ><Check :size="14" /> Completed drafts</span
            >
            <span class="inline-flex items-center gap-1.5"
    ...
    >
      <div class="lg:sticky lg:top-24 lg:self-start">
        ...
        <h2 class="mt-2 text-3xl font-semibold tracking-tight">
          More useful than a letter by itself
        </h2>
        <p class="mt-4 leading-7 text-muted-foreground">
          The team score is the summary. The draft order, player cost, and
          league comparison are the evidence you can inspect underneath it.
        </p>
      </div>
      <ol class="border-t">
        <li
          v-for="view in gradeViews"
          :key="view.number"
    ...
    <section class="border-y bg-muted/30">
      <div class="max-w-6xl px-5 py-16 mx-auto sm:py-20">
        <div class="max-w-3xl">
          ...
          <h2 class="mt-2 text-3xl font-semibold tracking-tight">
            Draft cost, projected value, then league context
          </h2>
          <p class="mt-4 leading-7 text-muted-foreground">
            Grades are estimates, not season predictions. The method is designed
            to make the assumptions visible enough to disagree with them
            intelligently.
          </p>
        </div>
        <ol
    ...
    <section class="max-w-6xl px-5 py-16 mx-auto sm:py-20">
      <div class="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
        ...
        <div
          class="grid overflow-hidden border divide-y rounded-card bg-background sm:grid-cols-2 sm:divide-x sm:divide-y-0"
        >
          <article
          ...
          >
            ...
            <Button
              ...
              class="mt-6"
            >
              <RouterLink to="/fantasy-football-draft-room-example">
    ...
    <section class="max-w-6xl px-5 py-16 mx-auto sm:py-20">
      <div class="max-w-3xl">
        ...
        <h2 class="mt-2 text-3xl font-semibold tracking-tight">
          Use the draft already attached to your league
        </h2>
        <p class="mt-4 leading-7 text-muted-foreground">
          There is no draft board to rebuild. Connect the platform that hosted
          your league, then open Draft after the completed picks load.
        </p>
      </div>
      <div class="grid gap-4 mt-9 sm:grid-cols-2">
        <RouterLink
          to="/sleeper-league-analyzer"
          class="p-6 transition-colors border rounded-card bg-background hover:border-primary/50 sm:p-7"
        >
          <h3 class="text-lg font-semibold">
            Sleeper fantasy football draft grades
          </h3>
          <p class="mt-2 text-sm leading-6 text-muted-foreground">
            Connect by Sleeper username or league ID and review the completed
            snake or auction draft data available for that league.
          </p>
          <p class="mt-5 text-sm font-medium text-primary">
            Analyze a Sleeper league →
          </p>
        </RouterLink>
        <RouterLink
          to="/espn-league-analyzer"
          class="p-6 transition-colors border rounded-card bg-background hover:border-primary/50 sm:p-7"
        >
          <h3 class="text-lg font-semibold">
            ESPN fantasy football draft grades
          </h3>
          <p class="mt-2 text-sm leading-6 text-muted-foreground">
            Connect the correct ESPN league and season, including private
            leagues, to load the draft results ESPN makes available.
          </p>
          <p class="mt-5 text-sm font-medium text-primary">
            Analyze an ESPN league →
          </p>
        </RouterLink>
      </div>
    </section>
    ...
    <section class="max-w-4xl px-5 py-16 mx-auto sm:py-20">
      ...
      <h2 class="mt-2 text-3xl font-semibold tracking-tight">
        Fantasy football draft grade questions
      </h2>
      ...
      >
        ...
        <div class="relative">
          <h2 class="text-2xl font-semibold tracking-tight">
            Put your draft room under review
          </h2>
          <p class="max-w-2xl mt-2 leading-7 text-primary-foreground/80">
            Connect the league, open Draft, and compare every manager’s picks
            with the value available at the time.
          </p>
        </div>
        <Button as-child size="lg" variant="secondary" class="relative shrink-0"
          ><RouterLink :to="analysisRoute"
            >Analyze your draft</RouterLink
          ></Button
        >
      </div>
    </section>
